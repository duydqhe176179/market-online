...
const ResponseAfterPayment = () => {
    ...
    const paymentSuccess = async (vnp_OrderInfo, vnp_ResponseCode) => {
        try {
            const response = await axios.post(`${BASE_URL}/api/payment/payment-response-info?vnp_OrderInfo=${vnp_OrderInfo}&vnp_ResponseCode=${vnp_ResponseCode}`);
        ...
        >
            ...
            >
                ...
                >
                    ...
                    <div style={{ color: "black" }}>{vnp_PayDate}</div>
                </div>
                <div
                    style={{
                        color: "#B3B4B6",
...
export default ResponseAfterPayment;
